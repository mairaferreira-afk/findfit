# Consuming FindFit Design System in web apps

Read `artifacts/findfit-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/findfit-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/findfit-ds/styles.css";
```
...
`node_modules/@workspace/findfit-ds/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/findfit-ds/hooks/use-toast";
```
...
`@workspace/findfit-ds/components/ui/button`. Run the app's typecheck
