# Migrating web UI to FindFit Design System

Read `artifacts/findfit-ds/docs/AGENTS.md` and
`artifacts/findfit-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/findfit-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/findfit-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/findfit-ds/hooks/use-toast`
