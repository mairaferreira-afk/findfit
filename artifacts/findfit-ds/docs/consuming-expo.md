# Consuming FindFit Design System in Expo apps

Read `artifacts/findfit-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/findfit-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/findfit-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/findfit-ds/lib/native-theme";
import { useColors } from "@workspace/findfit-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/findfit-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/findfit-ds/components/native/badge";
import { Button } from "@workspace/findfit-ds/components/native/button";
import { Card } from "@workspace/findfit-ds/components/native/card";
```
...
Import and render
`@workspace/findfit-ds/components/native/button`, then run Expo
