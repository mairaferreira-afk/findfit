...
const FindFitGuidelinesDemo = lazyPage(() =>
  import('./demos/findfit-guidelines').then(({ FindFitGuidelinesDemo }) => FindFitGuidelinesDemo),
);
...
export const OVERVIEW_ENTRY: PreviewEntry = {
  id: 'overview',
  name: 'Overview',
  description: 'Fundações visuais e princípios que moldam este sistema.',
  Page: OverviewPage,
};
...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    entries: [
      {
        id: 'findfit-guidelines',
        name: 'Guidelines',
        description: 'Princípios de design, fotografia, composição e tom de comunicação do FindFit.',
        Page: FindFitGuidelinesDemo,
      },
    ],
  },
  {
